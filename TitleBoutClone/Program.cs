    ...
    class Program
    {
        ...
        private static void TrySimulatingBout()
        {
            ...
            Fighter redCorner = new Fighter(id: 1, surname: "Ali", controlAgainstS: 11, controlAgainstB: 12,
                aggression: 6, power: 6, endurance: 85, knockdownChance: 5, defence: 0, chin: 2, finishing: 7, recovery: 3, counterpunching: 6, openToCounterpunch: 42,
            ...
            Fighter blueCorner = new Fighter(id: 2, surname: "Foreman", controlAgainstB: 11, controlAgainstS: 12,
                aggression: 8, power: 12, endurance: 78, defence: 2, knockdownChance: 8, chin: 1, finishing: 7, recovery: 5, counterpunching: 4, openToCounterpunch: 42, punchLandedRange: new Range(1, 37),
